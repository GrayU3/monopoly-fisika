...
square[3] = new Square("Science Complex", "$60", "#8B4513", 60, 3, 4, 20, 60, 180, 320, 450);
square[4] = new Square("City Tax", "Pay $200", "#FFFFFF");
square[5] = new Square("Reading Railroad", "$200", "#FFFFFF", 200, 1);
square[6] = new Square("Science Complex", "$100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
...
square[9] = new Square("Science Complex", "$120", "#87CEEB", 120, 4, 8, 40, 100, 300, 450, 600);
square[10] = new Square("Just Visiting", "", "#FFFFFF");
square[11] = new Square("Science Complex", "$140", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
...
square[14] = new Square("Science Complex", "$160", "#FF0080", 160, 5, 12, 60, 180, 500, 700, 900);
...
square[19] = new Square("Science Complex", "$200", "#FFA500", 200, 6, 16, 80, 220, 600, 800, 1000);
...
square[24] = new Square("Science Complex", "$240", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
...
square[27] = new Square("Science Complex", "$260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("Water Works", "$150", "#FFFFFF", 150, 2);
square[29] = new Square("Science Complex", "$280", "#FFFF00", 280, 8, 24, 120, 360, 850, 1025, 1200);
...
square[32] = new Square("Science Complex", "$300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[33] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[34] = new Square("Science Complex", "$320", "#008000", 320, 9, 28, 150, 450, 1000, 1200, 1400);
...
square[39] = new Square("Science Complex", "$400", "#0000FF", 400, 10, 50, 200, 600, 1400, 1700, 2000);
